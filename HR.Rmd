...
drinks %>% 
  ...
  slice(1:25) %>% 
  ggplot(aes(x = reorder(country, -beer_servings), y = beer_servings, fill = country)) +
  geom_col() +
  theme_minimal()
...
drinks %>% 
  ...
  slice(1:25) %>% 
  ggplot(aes(x = reorder(country, -wine_servings), y = wine_servings, fill = country)) +
  geom_col() +
  theme_minimal()
...
hr_cleaned %>% 
  ...
  geom_col() +
  labs(title = "distribution of job_satisfaction") +
  theme_economist()
...
hr_cleaned %>% 
  ...
  geom_col() +
  labs(title = "distribution of work_life_balance") +
  theme_economist()
```
...
hr_cleaned %>% 
  ...
  geom_boxplot() +
  labs(title = "income of different job roles", y = "") +
  theme_economist()
```
...
hr_cleaned %>% 
  ...
  theme_economist() +
  labs(title = "distribution of income by education level", y = "")
